...
## Iteration-11 v2.10 repair: authoritative review bytes and complete five-leaf proof graph

The cycle-9 native Architect `APPROVE` sequence 1 and cycle-6 native Critic `REVISE` sequence 2 are immutable v2.9 history at SHA-256 `5c7d3ce4c8156b5661ed69454c3ffb13196a712f6bec186adc35e0a89b040115` and `ad5c5faf68d1a4bc1b2ef8053b4a8f79cf67698bf454cbabb41c5b51b7b04c50`. Both reviewed amendment SHA-256 `4e97bb4a060fe03f2edd20ff79eb1c22d8076f8a992f78e62797bbe92278ad66`; the Critic artifact links the Architect artifact hash. Attempt 6 remained unauthorized and unstarted.

Before successor edits, the amendment, test, run index, and evidence manifest were archived byte-identically under `docs/evidence/rjc-256/superseded/v2.9/`. Their SHA-256 values are respectively `4e97bb4a060fe03f2edd20ff79eb1c22d8076f8a992f78e62797bbe92278ad66`, `d30bfe7a7860e3196c57bd24db383def8d734555f562508615200ee3bef1a59c`, `40b987cde81be833b2826f1d1a6093487d1db858c875498c0b493db2a862d3bc`, and `4edd0392892fbe109ce7aa1428a1c0c1ef37149aa7e63bc91daec384eca87ab7`; the archived test Git blob is `3ca7323bb6a0448b6d3ba3679a4da6fa32b1b1b9`. Original Red metadata and transcript remain immutable at SHA-256 `4ef9ea2728f76896b4d19f0e55717371cf72e22395c60f8228d21d1f47f1d8a6` and `87366be13a21f9900ef7c4da2a21474006bf4813b7f28a7bf1bf1a6d7d00eecb`. The review-complete pre-transition state SHA-256 is `8227a73c5b603ea848196812b48cdffb1c9dd2b4c8bb13c1f8caa67ada08e4db`.

The consensus helper must read the actual fresh review artifacts at `.omx/plans/rjc-256-peer-compatibility-architect-review-cycle10.md` and `.omx/plans/rjc-256-peer-compatibility-critic-review-cycle7.md`. Each artifact has exactly one canonical Markdown title and one exact ordered header envelope. Architect headers are verdict, role, native lane, completion timestamp, reviewed amendment SHA-256, and sequence index. Critic headers add the prior Architect artifact SHA-256 immediately before sequence. Unknown, missing, duplicate, reordered, malformed, noncanonical, or contradictory fields reject. Actual bytes, actual SHA-256, exact-key state records, aliases, amendment identity, role, lane, timestamp, sequence, Critic prior linkage, and the matching native tracker lane records must all agree. Required consensus remains fresh Architect `APPROVE` sequence 1 followed later by Critic `APPROVE` sequence 2.

The stopped-container producer already copies and re-hashes all five exact program bytes before acquisition: runner, preflight, post-lock, classifier, and consensus helper. Future Green requires their captured paths `captures/rjc-256-g003b-attempt6.sh`, `captures/rjc-256-g003b-attempt6-preflight.sh`, `captures/rjc-256-g003b-attempt6-post-lock.sh`, `captures/rjc-256-pnpm-audit-classifier.mjs`, and `captures/rjc-256-attempt6-consensus-gate.mjs` to exist with their actual byte digest in all three of leaf-only `SHA256SUMS`, `spike.artifact_hashes`, and `spike.leaf_digests`. Missing captures, changed bytes, or either map drifting must reject independently for every leaf.

Iteration and review cycle are 11. v2.9 is `superseded_without_green`; current reviews and aliases are null; consensus is incomplete; attempt 6 remains unauthorized and unstarted. Fresh review may begin only after genuine v2.10 Red is frozen. No attempt-6, Docker, network, registry, Linear, or RJC-257 action is authorized by this repair.

## Iteration-12 v2.11 repair: exact sequence lexeme canonicality

The cycle-10 native Architect `REVISE` sequence 1 is immutable v2.10 history at SHA-256 `d84ab110009939b033857e5fc8bf196f962adfffac386572938b894ec5d29505`. It reviewed amendment SHA-256 `9933a5dc4b971a46c07315dbae5406cb8472b6ba150821ff2bc725fb0e1252ae` and reproduced a fully synchronized noncanonical sequence header surviving lossy `Number(...)` conversion. Attempt 6 remained unauthorized and unstarted.

Before successor edits, the amendment, test, run index, and evidence manifest were archived byte-identically under `docs/evidence/rjc-256/superseded/v2.10/`. Their SHA-256 values are respectively `9933a5dc4b971a46c07315dbae5406cb8472b6ba150821ff2bc725fb0e1252ae`, `1707ffd06d1098474c9a96b4f0eef4cd558132b961da2ee33dd0848960ad00bf`, `079af82873cd47ed93c0c133bd4619b4fd169b4a9f96b1a552626d6fa10cf457`, and `4c9a54d5ae8a78766aaaca4890e129317f41589ec22ec653e241ec997f96ac52`; the archived test Git blob is `d5abbe663dc38b16b72d897e8752348feaf4054c`. Original Red metadata and transcript remain immutable at SHA-256 `62d40cc691b8ac49c68723d6e1df028a4b2c02ee2d4e842c51732c7dc8a9a591` and `632f0192201dd7d04f2aa0a9c3a8adf3e0396ae00913c3d5ccd87904548e5f0c`. The review-bound pre-transition state and tracker SHA-256 values are `6418c2169f9aeec3f6b8446f49f510aa55fd5c4f6a624d743652998869b23b7b` and `9ee0e702a5c2f9dfcfd60696dc0d00f970f593773d5a36bd8770366471c2887a`.

The canonical review parser must validate the sequence header lexeme before numeric conversion. Architect permits exactly ASCII `1`; Critic permits exactly ASCII `2`. Leading zeros, signs, decimal forms, surrounding or internal whitespace, and Unicode digits reject even when artifact bytes, artifact SHA, state record, review alias, Critic linkage, and native tracker summary are changed together to preserve the same numeric meaning. Every v2.10 review-byte, tracker, amendment, execution-program, isolation, audit, provenance, and five-capture three-way checksum-graph control remains unchanged.

Iteration and review cycle are 12. v2.10 is `superseded_without_green`; the cycle-10 REVISE is prior-only history; current reviews and aliases are null; consensus is incomplete; attempt 6 remains unauthorized and unstarted. Fresh review paths advance to native Architect cycle 11 at `.omx/plans/rjc-256-peer-compatibility-architect-review-cycle11.md` followed later by native Critic cycle 8 at `.omx/plans/rjc-256-peer-compatibility-critic-review-cycle8.md`. Fresh review may begin only after genuine v2.11 Red is frozen. No attempt-6, Docker, network, registry, Linear, or RJC-257 action is authorized by this repair.
